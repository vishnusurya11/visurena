...
> **Version target:** Three.js **r184** (March 2026 release) and newer. APIs here track the modern `three`/`three/addons` import paths. WebGPU became a one-line swap from WebGL at **r171** (Sept 2025); WebGPU reached Baseline across all major browsers in 2026, so `WebGPURenderer` (with automatic WebGL2 fallback) is now a safe default for new projects. *Last revised: 2026-05-23.*

**Core documentation**
- Three.js API docs (class reference): https://threejs.org/docs/ — e.g. [`WebGLRenderer`](https://threejs.org/docs/#api/en/renderers/WebGLRenderer), [`WebGPURenderer`](https://threejs.org/docs/#api/en/renderers/WebGPURenderer), [`Scene`](https://threejs.org/docs/#api/en/scenes/Scene), [`PerspectiveCamera`](https://threejs.org/docs/#api/en/cameras/PerspectiveCamera)
- Three.js Manual (tutorials & fundamentals): https://threejs.org/manual/
- Three.js examples (copy-paste reference for loaders, post-processing, controls): https://threejs.org/examples/
- Release notes / changelog (check before relying on an API): https://github.com/mrdoob/three.js/releases
- Migration guide (breaking changes between revisions): https://github.com/mrdoob/three.js/wiki/Migration-Guide

**Shaders (GLSL & TSL)**
- TSL — Three.js Shading Language (node-based shaders that compile to both GLSL/WebGL2 and WGSL/WebGPU; the recommended modern path for custom materials). Authoritative spec is the wiki: https://github.com/mrdoob/three.js/wiki/Three.js-Shading-Language — also listed in the docs sidebar at https://threejs.org/docs/ under "TSL"
- The Book of Shaders (GLSL fundamentals): https://thebookofshaders.com/
- Shadertoy (fragment-shader inspiration & examples): https://www.shadertoy.com/

**WebGPU / WebGL specs**
- WebGPU spec (W3C Candidate Recommendation): https://www.w3.org/TR/webgpu/
- WebGPU editor's draft (GPU for the Web WG): https://gpuweb.github.io/gpuweb/
- WGSL (WebGPU Shading Language) spec: https://www.w3.org/TR/WGSL/
- MDN WebGPU API overview: https://developer.mozilla.org/en-US/docs/Web/API/WebGPU_API
- MDN WebGL API: https://developer.mozilla.org/en-US/docs/Web/API/WebGL_API

**Tooling**
- glTF 2.0 spec (model format): https://www.khronos.org/gltf/
- glTF validator / report: https://github.khronos.org/glTF-Validator/
