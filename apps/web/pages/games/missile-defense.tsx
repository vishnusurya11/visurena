...
export default function MissileDefensePage() {
  const router = useRouter();

  return (
    <Layout pageTheme="games">
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-red-900/20 to-black">
        ...
        >
          <div className="w-full h-[calc(100vh-120px)] min-h-[500px]">
            <GamePlaceholder 
              ...
              description="Protect your cities from incoming missiles with strategic defense systems and chain reaction explosions!"
              color="#ff0000"
            />
          </div>
        </motion.div>
