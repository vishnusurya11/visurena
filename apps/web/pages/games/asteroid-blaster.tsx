...
export default function AsteroidBlasterPage() {
        ...
        >
          <div className="w-full h-[calc(100vh-120px)] min-h-[500px]">
            <GamePlaceholder 
              ...
              description="Pilot your ship through dangerous asteroid fields with 360° rotation and physics-based destruction!"
              color="#00ffff"
            />
          </div>
        </motion.div>
