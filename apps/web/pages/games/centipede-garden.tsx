...
export default function CentipedeGardenPage() {
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900/20 to-black">
        ...
        >
          <div className="w-full h-[calc(100vh-120px)] min-h-[500px]">
            <GamePlaceholder 
              title="Centipede Garden" 
              description="Defend your garden from centipedes and other insects in this vibrant, action-packed shooter!"
              color="#ff00ff"
            />
          </div>
        </motion.div>
