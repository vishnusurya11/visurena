    ...
    <Layout pageTheme="games">
      <div className="container mx-auto px-6 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="font-display text-4xl font-bold mb-4 text-jewel-amethyst">Games</h1>
          <p className="text-lg mb-6 text-jewel-ivory/60">Play exciting games right in your browser</p>
              ...
              {allTags.map((tag) => (
                <button
                  ...
                  className={`px-4 py-1 text-sm transition-colors ${
                    filter === tag
                      ? 'text-jewel-amethyst border-b-2 border-jewel-amethyst'
          ...
          <div className="text-center py-20">
            <div className="mb-8">
              <motion.div
                ...
                className="inline-block p-8 bg-ink-raise border border-jewel-ivory/10 rounded-2xl"
              >
                <svg className="w-24 h-24 text-jewel-amethyst" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xl text-jewel-ivory/60">Loading games...</p>
          </div>
        )}
      </div>
    </Layout>
