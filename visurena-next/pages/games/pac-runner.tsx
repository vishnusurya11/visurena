...
export default function PacRunnerPage() {
  const router = useRouter();

  return (
    <Layout pageTheme="games">
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-yellow-900/20 to-black">
        ...
        >
          <div className="w-full h-[calc(100vh-120px)] min-h-[500px]">
            <GamePlaceholder 
              title="Pac-Runner" 
              description="Navigate through neon mazes, collect pellets, and avoid ghosts in this cyberpunk twist on the classic arcade game!"
              color="#ffff00"
            />
          </div>
        </motion.div>
